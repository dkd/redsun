      ...
      def self.included(base) # :nodoc:
        ...
        base.class_eval do
          ...
          searchable do
            ...
            # Updated at
            time :updated_on do
              content.updated_on unless content.nil?
            end
...
unless WikiPage.included_modules.include?(RedmineRedsun::Patches::WikiPagePatch)
  WikiPage.include RedmineRedsun::Patches::WikiPagePatch
end
